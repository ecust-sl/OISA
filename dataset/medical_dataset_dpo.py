...
class generation_train_dpo(Dataset):
    def __init__(self, transform, image_root, ann_root, tokenizer, max_words=100, dataset='mimic_cxr', args=None):
        ...
        self.args = args
        with open('/ssd/shilei/dataset/PromptMRG/clip_text_features.json', 'r') as f:
    ...
    def __getitem__(self, index):
        ...
        y_w = ann['y_w']
        y_l = ann['y_l']
        report_gt = ann['report_gt']
        # yw_source = ann['y_w_source']
        # yl_source = ann['y_l_source']
        # yw_f1 = ann[f'y_w_f1']
        # yl_f1 = ann[f'y_l_f1']
        # yw_b1 = ann[f'y_w_b1']
        # yl_b1 = ann[f'y_l_b1']
        # yw_cliq = ann['y_w_cliq']
        # yl_cliq = ann['y_l_cliq']
        # yw_green = ann[f'y_w_green']
        # yl_green = ann[f'y_l_green']
        # yw_green = ann[f'{yw_source}_green']
        # yl_green = ann[f'{yl_source}_green']
        # yw_margin_reward = yw_f1
        # yl_margin_reward = yl_f1
        ...
        return id, image, caption, y_w, y_l, cls_labels, clip_memory


class generation_eval_dpo(Dataset):
    def __init__(self, transform, image_root, ann_root, tokenizer, max_words=100, split='val', dataset='mimic_cxr',
                 args=None):
        self.annotation = json.load(open(os.path.join(ann_root), 'r'))
    ...
    def __getitem__(self, index):
        ...
        return id, image, caption, cls_labels, clip_memory
